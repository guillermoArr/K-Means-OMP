...
// K-means clustering function (Parallelized with OpenMP)
...
int main() {
    ...
    string output_file = "output/" + to_string(numPoints) + "_results_parallel.csv";
    ...
    cout << "Tiempo de ejecucion en paralelo: " << parallel_time << "\n";
